---
description: Workflow para espelhar e gerar no Penpot 100% dos componentes do sistema, garantindo paridade total entre o código da aplicação e a prancheta Design System Library Components, com amarração estrita aos Core Tokens.
---
...
- Todos os componentes em `frontend/src/lib/components/ui/`:
  - `Button`
  - `Badge`
  - `Card`
  - `StatCard`
...
### 5. Validação
- Confirmar que a visualização web e o canvas do Penpot possuem paridade visual 1:1.
